...
tel = input ("Introducta el teléfono con el siguiente formato: +xx-yyyyyyyy-zz (por ejemplo +34-913724710-56)")
lista = tel.split('-')
print (lista[1])


#print ("El teléfono sin prefijo ni extensión es: ", tel[4:13]) Otra forma