...
npayaso = int (input('Introduce el número de payasos vendidos: '))
nmuneca = int (input('Introduce el número de muñecas vendidas: '))

print ('Peso total del paquete a enviar: ', ppayaso*npayaso + pmuneca*nmuneca, 'g')